...
func NewStubRoomRepository() *StubRoomRepository {
...
func (r *StubRoomRepository) ListAvailability(_ context.Context, filter domain.RoomAvailabilityFilter) ([]domain.RoomAvailability, error) {
	result := make([]domain.RoomAvailability, 0, len(r.rooms))
